...
const MarksOfFreedomSapporo2025: React.FC = () => {
  ...
  useEffect(() => {
    const fetchImages = async (page: number) => {
      ...
      const response = await fetch(`/api/images/marksoffreedom-sapporo-2025?page=${page}`); // 変更: ページ番号をクエリパラメータとして追加
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="w-full lg:w-2/3 mb-6 md:mb-12 mt-6">
        <p>&quot;Marks of Freedom - Sapporo 2025&quot;</p>
        <p className="mt-1 text-sm italic text-neutral-400">
          Snow, distance, and the edge of the grid.
        </p>
...
export default MarksOfFreedomSapporo2025;
