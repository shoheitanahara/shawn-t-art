  ...
  return (
    <div className="container mx-auto px-8 md:px-8 py-8 max-w-4xl">
      ...
      <div className="space-y-4">
        <p>NFTは、金のように扱うために生まれたものではありません。時間に消されないインクのようなものです。</p>
        ...
        <p>NFTs were never meant to be gold. They were meant to be ink. A way to leave a mark that time cannot erase.</p>
