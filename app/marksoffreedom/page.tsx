  ...
  return (
    <main className="w-full lg:w-3/4 px-6 md:px-12 lg:mx-auto pb-6">
      ...
      <div className="w-auto mx-auto lg:w-2/3 mb-6 md:mb-12 mt-6 text-left">
        ...
        <p className="mt-4">
          本シリーズは、都市の風景や構造物、光の反射など、
          人間が作り上げた秩序の中に潜む「自由」と「抑圧」の痕跡を記録しようとする実験である。
        </p>

        <p className="mt-4">
          デジタルというテクノロジーを通して、私は“人間的な感覚”を探っている。
          建築の影や反射、街の静けさの中に、わずかな呼吸のような自由を見出したいと思った。
        </p>

        <p className="mt-4">
          それは、The Double Slash で描いてきた「自由と制約のあいだにある線」を、
          現実の空間と時間の中で捉えようとする試みでもある。
        </p>

        <p className="mt-4">
          世界はノイズに満ちている。
          だからこそ、私は静けさの中に語られるものを信じたい。
        </p>

        <p className="mt-4">
          この写真群は、自由を肯定しながらも、
          その自由がどのように制御され、どこにまだ息づいているのかを見つめる行為である。
        </p>
