...
const EventPage = () => {
  return (
    <main className="px-6 md:px-24 pb-6">
      <h2 className="text-2xl font-bold text-center mb-4">Event</h2>
      <div className="flex flex-col items-center justify-between">
        <h2 className="text-2xl font-bold text-center mb-4">SORA Halloween 2025 @Spatial Metaverse</h2>
      ...
      <div className="flex flex-col items-center justify-between">
        <h2 className="text-2xl font-bold text-center mb-4">SORA Opening 2025 @Spatial Metaverse</h2>
        <div className="w-full lg:w-2/3 mb-16">
          <div>
            <div className="flex flex-col lg:flex-row mt-4 bg-white">
