  ...
  return (
    <div className="container mx-auto px-8 md:px-8 py-8 max-w-4xl">
      ...
      <div className="space-y-4">
        ...
        <p>NFTコレクターとしても活動し、Mutant Ape Yacht Club(MAYC)、Meebits、BasedApeGang などを保有しながら、アートとブロックチェーン文化を結ぶ初期のWeb3シーンに積極的に関わっています。</p>
        <p>モットーは</p>
