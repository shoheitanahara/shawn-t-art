...
const AboutPage: FC = () => {
  return (
    <div className="container mx-auto px-8 md:px-8 py-8 max-w-4xl">
      <h1 className="text-3xl font-bold mb-6">Shawn T. のポートフォリオ</h1>
      ...
      <div className="space-y-4">
        <p>私はShawn T.です。ポップアートに強く影響を受け、2100年代の未来と1950年代のヴィンテージを融合させた独創的で不思議な絵を描いています。私の作品は、色彩豊かで視覚的に魅力的なスタイルが特徴です。</p>
        ...
        <p>最新技術を駆使して、高速で動作するこのサイトは、私のアートの美しさとサイトの美しさを際立たせています。作品はNFTとして公開予定で、デジタルアートの新しい可能性を探求しています。私のアートが未来のアートシーンにおいて重要な役割を果たすことを願っています。私はWebエンジニアでもあり、アートと技術の融合を追求しています。</p>
      </div>
      ...
      <div className="mt-8">
        ...
        <div className="space-y-4">
          ...
          <p>My name is Shawn T. I create unique and whimsical art that is heavily influenced by pop art, blending the futuristic visions of 2100s with the vintage aesthetics of the 1950s. My works are characterized by vibrant colors and visually captivating styles.</p>
          ...
          <p>Utilizing the latest technology, this site operates at high speed, highlighting the beauty of my art and the site itself. My works are set to be released as NFTs, exploring new possibilities in digital art. I hope my art will play a significant role in shaping the future art scene. I am also a web engineer, pursuing the fusion of art and technology.</p>
        </div>
      </div>
